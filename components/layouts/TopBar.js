  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-300">
        <div className="grid grid-cols-4 gap-4 justify-between items-center bg-white dark:bg-black dark:bg-opacity-80 p-4 shadow-sm border dark:border-black">
          {/* Left - Logo */}
              ...
              <Popover className="relative w-max ml-auto">
                {({ open }) => (
                  ...
                  text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-400 group py-2 rounded-md inline-flex items-end text-base font-medium`}
                    ...
                    >
                      <Popover.Panel className="absolute w-screen max-w-sm mt-3 transform ml-3 -translate-x-full left-full sm:px-0 lg:max-w-3xl">
