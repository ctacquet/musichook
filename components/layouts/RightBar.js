          ...
          {colorTheme === "light" ? (
            <div className="py-4">
              <Switch
                ...
                className={`${enabled ? "bg-indigo-500" : "bg-indigo-400"} test
              ...
              >
                <span
                  ...
                  className={`${enabled ? "translate-x-9" : "translate-x-0"}
                          pointer-events-none inline-block h-[24px] w-[24px] rounded-full text-black bg-white shadow-lg transform ring-0 transition ease-in-out duration-200`}
                >
          ...
          relative inline-flex flex-shrink-0 h-[28px] w-[64px] border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
              >
                <span
                  aria-hidden="true"
                  className={`${enabled ? "translate-x-9" : "translate-x-0"}
                        pointer-events-none inline-block h-[24px] w-[24px] rounded-full text-gray-500 bg-white shadow-lg transform ring-0 transition ease-in-out duration-200`}
                >
                  <MoonIcon className="h-6 w-6 inline" />
                </span>
              </Switch>
            </div>
          )}
